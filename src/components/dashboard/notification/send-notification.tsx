      ...
      <CardContent className="flex flex-col gap-6 px-6 pb-6 pt-0">
            ...
            {(["All", "Promoters", "Businesses"] as TargetAudience[]).map((type) => {
              ...
              return (
                <button
                  ...
                  className={`flex-1 h-9 rounded-lg text-xs font-semibold transition-all duration-200 z-10 ${
                    isActive 
        ...
        <div className="flex flex-col gap-2">
          ...
          <Input 
            ...
            className="h-10 bg-[#00152B] border-[#0A355C] text-white placeholder:text-[#94A3B8] focus-visible:ring-1 focus-visible:ring-[#C7F556] rounded-lg"
          />
        </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <textarea 
            ...
            className="min-h-[120px] bg-[#00152B] border-[#0A355C] text-white placeholder:text-[#94A3B8] focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[#C7F556] rounded-lg p-3 resize-none border"
          ></textarea>
        </div>
        ...
        <div className="flex items-center gap-3 pt-2">
          <Button 
            ...
            className="h-10 px-6 text-xs text-[#94A3B8] border border-[#0A355C] bg-transparent hover:bg-[#0A355C] hover:text-white rounded-lg"
          >
            Clear
          </Button>
          <Button 
            disabled={isSendDisabled}
            className={`h-10 flex-1 text-xs font-semibold rounded-lg transition-colors ${
              isSendDisabled 
                ? "bg-[#0A355C] text-[#94A3B8] opacity-50 cursor-not-allowed" 
                : "text-[#00152B] bg-[#C7F556] hover:bg-[#bce65c]"
            }`}
          >
